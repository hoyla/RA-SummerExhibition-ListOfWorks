    ...
    for a in artists:
        ...
        if ovr is not None:
            ...
            auto_resolved_obj = AutoResolvedFields(
                ...
                artist2_shared_surname=auto.artist2_shared_surname,
                artist3_shared_surname=auto.artist3_shared_surname,
            )
            override_obj = IndexArtistOverrideOut(
                ...
                artist2_shared_surname_override=ovr.artist2_shared_surname_override,
                artist3_shared_surname_override=ovr.artist3_shared_surname_override,
...
def _override_to_out(override: IndexArtistOverride) -> IndexArtistOverrideOut:
    return IndexArtistOverrideOut(
        ...
        artist2_shared_surname_override=override.artist2_shared_surname_override,
        artist3_shared_surname_override=override.artist3_shared_surname_override,
...
def unmerge_artist(
    ...
    for src_row, cns in sorted(groups.items()):
        ...
        new_artist = IndexArtist(
            ...
            artist2_shared_surname=artist.artist2_shared_surname,
            artist3_shared_surname=artist.artist3_shared_surname,
